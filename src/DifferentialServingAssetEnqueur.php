...
class DifferentialServingAssetEnqueur extends JsonAssetEnqueuer
{
    ...
    {
        parent::__construct($assetManager, $manifestPath,$dest, $prefix);
    ...
    {
        return $_SERVER['DOCUMENT_ROOT'] . $this->dest;
    }
    ...
    /** @inheritdoc */
    public function enqueueCritical(array $handle)
    {
        $this->enqueueCriticalFn($handle, self::BUILD_TYPE_LEGACY);
    }
